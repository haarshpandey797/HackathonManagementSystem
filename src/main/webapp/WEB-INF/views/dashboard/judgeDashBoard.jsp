                    ...
                    <ul>
                        ...
                        <li>
                            <button class="run-btn">
                                <a href="showGrid" style="display: flex; align-items: center; gap: 10px; background: #318CE7; border: 0.5px solid #DDE3EC; border-radius: 5px; font-size: 16px; line-height: 24px; color: white; cursor: pointer; padding: 5px 20px; transition: all .3s ease-in-out;">
                                     Evaluation
                                </a>
                            </button>
                        </li>
